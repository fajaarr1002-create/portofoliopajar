...
const _0x4fb81 = [
  'am9pbiBDaGFubmVsIFBhamFyIERldg==',
  'aHR0cHM6Ly93aGF0c2FwcC5jb20vY2hhbm5lbC8wMDI5VmJDaWQ5STdZU2Q4Y3hQQjhnMHU=',
  'UGFqYXIgRGV2'
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] text-gray-800 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      {/* 🚀 Jar Dev Obfuscated WhatsApp Channel Promo Top Bar */}
      <AnimatePresence>
        {showPromo && (
          <motion.div 
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-6 py-10 md:py-16 flex flex-col items-center justify-center gap-10">
        ...
        <div className="text-center max-w-2xl flex flex-col items-center gap-3">
          ...
          >
            Professional AI upscaling using the Jar engine. Fast, clean, and lossless file structures.
          </motion.p>
        </div>
